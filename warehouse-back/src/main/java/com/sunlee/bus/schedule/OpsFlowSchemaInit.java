...
public class OpsFlowSchemaInit implements CommandLineRunner {
    ...
    public void run(String... args) {
        try {
            ...
            addCol("ops_flow_docs", "receipt_id", "BIGINT DEFAULT NULL COMMENT '银行到账流水'");
            addCol("ops_flow_docs", "hang_flag", "TINYINT DEFAULT 0 COMMENT '1挂账不改发票回款'");
            addCol("ops_flow_items", "related_no", "VARCHAR(64) DEFAULT NULL COMMENT '冲账发票号'");
            jdbcTemplate.execute("""
                    CREATE TABLE IF NOT EXISTS bank_receipts (
                      ...
                      voucher_no VARCHAR(64) DEFAULT NULL COMMENT '回单号或支票号',
