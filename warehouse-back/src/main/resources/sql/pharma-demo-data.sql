...
VALUES
  (300001, '300001', '药品', '阿莫西林胶囊', '阿莫仙', '0.25g*24粒', '胶囊', '盒', '联邦制药厂有限公司', '国药准字H44021351', '69079921100272', 0, '处方药', 8.60, 12.80, 1, NULL, NOW(), NOW()),
...
VALUES
  ...
  (6, 'SPD20260907001', '69079921100272', '最小包装', '入库', '正常', '2026-09-05 10:22:00', '平板扫码演示', NOW(), NOW())
